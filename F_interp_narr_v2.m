function outp_interp_narr = F_interp_narr_v2(inp_interp_narr)
% simplified from F_interp_narr.m on 2018/05/07
...
intx = true(size(narr_data_3d.x));
inty = true(size(narr_data_3d.y));
